...
public class ConfigReposControllerV3 extends ApiController implements SparkSpringController, CrudController<ConfigRepoConfig> {
    ...
    @Autowired
    public ConfigReposControllerV3(ApiAuthenticationHelper authHelper, ConfigRepoService service, EntityHashingService entityHashingService) {
        super(ApiVersion.v3);
    ...
    String index(Request req, Response res) {
        ...
        return jsonizeAsTopLevelObject(req, w -> ConfigReposConfigRepresenterV3.toJSON(w, repos));
    }
