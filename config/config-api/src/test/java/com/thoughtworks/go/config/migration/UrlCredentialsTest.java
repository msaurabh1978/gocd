...
class UrlCredentialsTest {
    ...
    void shouldReturnNormalizedURl(String expectedUrl, String originalUrl, String expectedUsername, String expectedPassword, String expectedDenormalizedUrl) {
        String normalizedUrl = UrlCredentials.urlWithoutCredentials(originalUrl);
        String username = UrlCredentials.getUsername(originalUrl);
        String password = UrlCredentials.getPassword(originalUrl);
        ...
        String urlWithCredentials = UrlCredentials.urlWithCredentials(normalizedUrl, username, password);
